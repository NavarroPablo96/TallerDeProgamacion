 ...
 */
public class Ventana_Paciente extends JFrame implements  KeyListener , IVistaPaciente,MouseListener{
	...
	public Ventana_Paciente() {
		...
		panelSuperiorIzquierdo.add(lblListaPacientes);
		try {
		...
		panelDerecho.setLayout(new GridLayout(9, 0, 0, 0));
		...
		JPanel panelRangoEtario = new JPanel();
		FlowLayout fl_panelRangoEtario = (FlowLayout) panelRangoEtario.getLayout();
		fl_panelRangoEtario.setVgap(20);
		fl_panelRangoEtario.setHgap(30);
		panelDerecho.add(panelRangoEtario);
		
		JLabel lblRangoEtario = new JLabel("Rango Etario:");
		lblRangoEtario.setHorizontalAlignment(SwingConstants.CENTER);
		lblRangoEtario.setFont(new Font("Tahoma", Font.PLAIN, 15));
		panelRangoEtario.add(lblRangoEtario);
	...
	/**
	 * Metodo que a�ade un Action Listener a cada boton de la ventana 
	 */
	@Override
	public void addActionListener(ActionListener listener) {
		this.btnAgregar.addActionListener(listener);
		this.btnEliminar.addActionListener(listener);
		this.comboBox_RangoEtario.addActionListener(listener);
    ...
    /**
	 * M�todo que devuelve el item seleccionado del comboBox de rango etario de un paciente, en formato String<br>
	 * @return Devuelve un String del rango etario de un paciente el cual puede ser: ni�o, joven o Mayor. 
	 */
	@Override
	public String getMensajeRangoEtario() {
		return (String)comboBox_RangoEtario.getSelectedItem();
	}
